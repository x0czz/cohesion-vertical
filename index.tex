...
ha adquiriere particular relevancia debido a la aparente erosión que ha
situado a organismos como el Congreso Nacional y los partidos políticos
con índices de confianza inferiores al 5\%
...
Chan, 2006}). Schiefer y van der Noll, en
(\citeproc{ref-_essentials_2017}{{«({PDF}) {The Essentials} of {Social
Cohesion}»}, 2017}) la definen como un componente constitutivo de la
convivencia que actúa como ``pegamento social'' al reducir los costos de
gobernanza y fomentar la adscripción voluntaria a las normas
(\citeproc{ref-kim_social_2021}{Kim et~al., 2021};
\citeproc{ref-ministeriodedesarrollosocialyfamilia_informe_2020}{Ministerio
...
cuando la evaluación de las autoridades sea negativa
(\citeproc{ref-_essentials_2017}{{«({PDF}) {The Essentials} of {Social
Cohesion}»},
...
advierte que la demanda de equidad en el trato y el rechazo a asimetrías
de poder son precondiciones para la legitimidad del sistema; por tanto,
las experiencias de maltrato percibido vinculadas frecuentemente al
clasismo tensionan el pacto social y profundizan la desafección vertical
(\citeproc{ref-araujo_igualdad_2013}{Araujo, 2013}).
...
Los hallazgos demuestran que la percepción de corrupción es el principal
detractor de la confianza; el impacto de la desconfianza crónica
(promedio personal a lo largod el tiempo) es cuatro veces superior al
del cambio a lo largo del tiempo. (β=−2.090 vs.~β=−0.494). Por el
contrario, la identificación nacional cuenta con un efecto positivo.
