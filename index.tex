...
ademas cuentan con información completa en las variables de interés. La
selección de este subconjunto garantiza la consistencia y la validez de
la comparacion entre modelos mediante Criterio de Informacion Baiesiano
(BIC).
...
ciudadana. Cabe mencionar que el R2 marginal de el ultimo modelo
reportado fue de 0.293\textless{} lo que indica que los predictores
fijos del estudio explican por sí solos casi un tercio de la
variabilidad en la confianza institucional. El R2 condicional por su
parte; que integra efectos fijos y aleatorios fue de 54.3\%. Esta
diferencia confirma que una parte sustancial de la desconfianza en Chile
es un rasgo crónico y persistente de los individuos que trasciende las
...
(efecto within). Este resultado valida los diagnósticos de la {«{La
confianza en las instituciones públicas de Chile}»}
